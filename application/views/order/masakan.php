...
<body>
                            ...
                            <?php foreach ($masakan as $key => $value): ?>
                                <div class="col-4">
                                    <div class="card" style="width: 15rem">
                                        <img class="card-img-top img-fluid" src="<?php echo base_url('uploads/').$value->gambar ?>" alt="">
                                        <div class="card-body" id="<?php echo $value->id ?>">
                                            ...
                                            <div class="input-group mt-3">
                                                ...
                                                <div class="input-group-append">
                                                    <button class="btn sec-bg-color tambah" >Tambah</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <div class="total d-flex mt-3">
                                        ...
                                        <div class="total-desc total-harga ">
                                            <h3 class="sec-color">Rp.0</h3>
                                        </div>
                                    </div>
                            ...
                            <div class="card-footer">
                                <button class="btn sec-bg-color btn-block bayar" disabled>Bayar</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="<?php echo base_url() ?>assets/js/masakan.js"></script>
</body>
